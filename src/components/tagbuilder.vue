...
export default {
  ...
  methods: {
    ...
    setDefaults: function() {
      ...
      'hide_tagsbutton', 'hide_autorunbutton', 'hide_infobutton', 'hide_overlaybutton', 'hide_layersbutton', 'hide_nextbuttons', 'hide_fullscreenbutton', 'hide_shortcutsbutton', 'transcription']
